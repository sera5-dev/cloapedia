		...
		<div class="masonry-blog clearfix">
			<div class="left-side">
				<div class="masonry-box post-media">
					<img src="<?= base_url('assets/') ?>upload/blog_masonry_01.jpg" alt="" class="img-fluid">
			...
			<div class="center-side">
				<div class="masonry-box post-media">
					<img src="<?= base_url('assets/') ?>upload/blog_masonry_02.jpg" alt="" class="img-fluid">
					<div class="shadoweffect">
						<div class="shadow-desc">
							<div class="blog-meta">
				...
				<div class="masonry-box small-box post-media">
					<img src="<?= base_url('assets/') ?>upload/blog_masonry_03.jpg" alt="" class="img-fluid">
					<div class="shadoweffect">
						<div class="shadow-desc">
							<div class="blog-meta">
								<span class="bg-green"><a href="blog-category-01.html" title="">Travel</a></span>
				...
				<div class="masonry-box small-box post-media">
					<img src="<?= base_url('assets/') ?>upload/blog_masonry_04.jpg" alt="" class="img-fluid">
					<div class="shadoweffect">
						<div class="shadow-desc">
							<div class="blog-meta">
								<span class="bg-green"><a href="blog-category-01.html" title="">Travel</a></span>
			...
			<div class="right-side hidden-md-down">
				<div class="masonry-box post-media">
					<img src="<?= base_url('assets/') ?>upload/blog_masonry_05.jpg" alt="" class="img-fluid">
					<div class="shadoweffect">
						<div class="shadow-desc">
							<div class="blog-meta">
								<span class="bg-aqua"><a href="blog-category-01.html" title="">Lifestyle</a></span>
	...
	<div class="container">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog-box">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_05.jpg" alt="" class="img-fluid">
						...
						<div class="blog-box">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_06.jpg" alt="" class="img-fluid">
									<div class="hovereffect">
										<span></span>
									</div><!-- end hover -->
								</a>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="blog-box">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_01.jpg" alt="" class="img-fluid">
									<div class="hovereffect">
										<span></span>
									</div><!-- end hover -->
								</a>
						...
						<div class="blog-box">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_02.jpg" alt="" class="img-fluid">
									<div class="hovereffect">
										<span></span>
									</div><!-- end hover -->
								</a>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="blog-box">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_03.jpg" alt="" class="img-fluid">
									<div class="hovereffect">
										<span></span>
									</div><!-- end hover -->
								</a>
						...
						<div class="blog-box">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_04.jpg" alt="" class="img-fluid">
									<div class="hovereffect">
										<span></span>
									</div><!-- end hover -->
								</a>
			...
			<div class="col-lg-10 offset-lg-1">
				<div class="banner-spot clearfix">
					<div class="banner-img">
						<img src="<?= base_url('assets/') ?>upload/banner_01.jpg" alt="" class="img-fluid">
					</div><!-- end banner-img -->
				</div><!-- end banner -->
			</div><!-- end col -->
		</div><!-- end row -->
		...
		<div class="row">
				...
				<div class="blog-list clearfix">
					...
					<div class="blog-box row">
						<div class="col-md-4">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_square_01.jpg" alt="" class="img-fluid">
					...
					<div class="blog-box row">
						<div class="col-md-4">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_square_02.jpg" alt="" class="img-fluid">
									<div class="hovereffect"></div>
								</a>
							</div><!-- end media -->
						</div><!-- end col -->
					...
					<div class="blog-box row">
						<div class="col-md-4">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_square_03.jpg" alt="" class="img-fluid">
									<div class="hovereffect"></div>
								</a>
							</div><!-- end media -->
						</div><!-- end col -->
				...
				<div class="blog-list clearfix">
					...
					<div class="blog-box row">
						<div class="col-md-4">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_square_05.jpg" alt="" class="img-fluid">
									<div class="hovereffect"></div>
								</a>
							</div><!-- end media -->
						</div><!-- end col -->
					...
					<div class="blog-box row">
						<div class="col-md-4">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_square_06.jpg" alt="" class="img-fluid">
									<div class="hovereffect"></div>
								</a>
							</div><!-- end media -->
						</div><!-- end col -->
					...
					<div class="blog-box row">
						<div class="col-md-4">
							<div class="post-media">
								<a href="single.html" title="">
									<img src="<?= base_url('assets/') ?>upload/blog_square_07.jpg" alt="" class="img-fluid">
									<div class="hovereffect"></div>
								</a>
							</div><!-- end media -->
						</div><!-- end col -->
			...
			<div class="col-lg-3">
				...
				<div class="blog-box">
					<div class="post-media">
						<a href="single.html" title="">
							<img src="<?= base_url('assets/') ?>upload/blog_10.jpg" alt="" class="img-fluid">
							<div class="hovereffect">
				...
				<div class="blog-box">
					<div class="post-media">
						<a href="single.html" title="">
							<img src="<?= base_url('assets/') ?>upload/blog_11.jpg" alt="" class="img-fluid">
							<div class="hovereffect">
								<span class="videohover"></span>
							</div><!-- end hover -->
						</a>
				...
				<div class="blog-box">
					<div class="post-media">
						<a href="single.html" title="">
							<img src="<?= base_url('assets/') ?>upload/blog_12.jpg" alt="" class="img-fluid">
							<div class="hovereffect">
								<span class="videohover"></span>
							</div><!-- end hover -->
						</a>
				...
				<div class="blog-box">
					<div class="post-media">
						<a href="single.html" title="">
							<img src="<?= base_url('assets/') ?>upload/blog_07.jpg" alt="" class="img-fluid">
							<div class="hovereffect">
								<span></span>
							</div><!-- end hover -->
						</a>
				...
				<div class="blog-box">
					<div class="post-media">
						<a href="single.html" title="">
							<img src="<?= base_url('assets/') ?>upload/blog_08.jpg" alt="" class="img-fluid">
							<div class="hovereffect">
								<span></span>
							</div><!-- end hover -->
						</a>
				...
				<div class="blog-box">
					<div class="post-media">
						<a href="single.html" title="">
							<img src="<?= base_url('assets/') ?>upload/blog_09.jpg" alt="" class="img-fluid">
							<div class="hovereffect">
								<span></span>
							</div><!-- end hover -->
						</a>
		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1">
				<div class="banner-spot clearfix">
					<div class="banner-img">
						<img src="<?= base_url('assets/') ?>upload/banner_02.jpg" alt="" class="img-fluid">
					</div><!-- end banner-img -->
				</div><!-- end banner -->
			</div><!-- end col -->
		</div><!-- end row -->
